...
const COMPONENT_CODE = `// Step 1: Install the HYELLO Payment Widget
npm install @hyello/payment-widget

// Step 2: Import the component
import { ReactCheckout } from '@hyello/payment-widget';
...
function PaymentPage() {
  ...
  const handleSuccess = (result) => {
    ...
    alert(\`Payment completed: \${result.amount} \${result.currency}\`);
  };
...
// Step 4: Add to your app routing
// In your app router (e.g., app/checkout/page.tsx)
// or pages router (e.g., pages/checkout.tsx)`;
...
async function install() {
  try {
    ...
    console.log(`${colors.bright}Installing card payment widget...${colors.reset}\n`);
    console.log(`Amount: $29.99 • Theme: dark\n`);
